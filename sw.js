...
const CORE_ASSETS = ['./','./index.html','./assets/styles.css','./js/app.js','./js/config.js','./js/geometry.js','./js/canvas.js','./js/heic.js','./js/image-decoder.js','./js/exporter.js','./js/ui.js','./js/pwa.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
